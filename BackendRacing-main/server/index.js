...
// CORS configuration
app.use(cors({
  origin: ['http://localhost:8080', 'http://localhost:3000', 'http://localhost:5173', 'http://localhost:15173', 'https://kris20f.github.io/Racing-F1', 'https://backendracing-main.fly.dev/api-docs'],
